...
import ChildDepositContainer from '../../Components/ChildDepositContainer.js';
import ChildWithdrawContainer from '../../Components/ChildWithdrawContainer.js';
import ChildTransferContainer from '../../Components/ChildTransferContainer.js';

function ChildAnyTransaction({ route, navigation }) {
    const { action } = route.params;
    switch (action) {
        case "Deposit":
            return <ChildDepositContainer
                handleBack = {() => navigation.goBack()}
            />
            break;
        
        case "Withdraw":
            return <ChildWithdrawContainer
                handleBack = {() => navigation.goBack()}
            />
            break;
        case "Transfer":
            return <ChildTransferContainer
                handleBack = {() => navigation.goBack()}
            />
            break;
        default:
